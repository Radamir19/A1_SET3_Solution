...
**График:**
*(Сюда следует вставить график для случайных массивов)*
```
[График производительности на случайных данных]
```
...
**График:**
*(Сюда следует вставить график для обратно отсортированных массивов)*
```
[График производительности на обратно отсортированных данных]
```
...
**График:**
*(Сюда следует вставить график для почти отсортированных массивов)*
```
[График производительности на почти отсортированных данных]
```
...
*   **Реализация алгоритмов**: [main.cpp](main.cpp)
*   **Собранные данные**: `results.csv` (файл с результатами замеров)
*   **ID посылки в CodeForces (задача A21)**: *(укажите ваш ID посылки)*
*   **Публичный репозиторий**: *(ссылка на ваш GitHub репозиторий)*
